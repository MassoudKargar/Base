namespace Base.Extensions.ChangeDataLog.Sql;
public class DapperEntityChangeInterceptorItemRepository : IEntityChangeInterceptorItemRepository
{
    ...
    private string InsertPropertyChangeLogItemCommand = "INSERT INTO [{0}].[{1}]([Id],[ChangeInterceptorItemId],[PropertyName],[Value]) VALUES (@Id,@ChageInterceptorItemId,@PropertyName,@Value)";
