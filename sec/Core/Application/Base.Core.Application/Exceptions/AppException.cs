...
public class AppException : Exception
{
    ...
    public AppException()
        : this(ApiResultStatusCode.EarlyHints)
    {
    }
    ...
    public AppException(string message)
        : this(ApiResultStatusCode.EarlyHints, message)
    {
    }

    public AppException(ApiResultStatusCode statusCode, string message)
        : this(statusCode, message, HttpStatusCode.EarlyHints)
    {
    }

    public AppException(string message, object additionalData)
        : this(ApiResultStatusCode.EarlyHints, message, additionalData)
    {
    }
    ...
    public AppException(ApiResultStatusCode statusCode, string message, object additionalData)
        : this(statusCode, message, HttpStatusCode.EarlyHints, additionalData)
    {
    }
